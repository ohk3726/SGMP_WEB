...
<div style="padding-top:80px;">
	...
	<div class="collapse" id="search_page">
		<form id=select_search method="POST" action="select_search">
			...
			<input type="text" id="search_text" name="search_text" value="${search_text}" onkeypress="if(event.keyCode==13){javascript:change_search();}"> 
		...
		<table class="table table-hover responsive-table">
			...
			<tbody>
				<c:forEach var="item" items="${list}">
					<tr onclick="javascript:click_productid('${item.prod_id}'); ">
						<td>${item.prod_id}
